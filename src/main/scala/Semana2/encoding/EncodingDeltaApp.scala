...
object EncodingDeltaApp extends App {
  ...
  val personV1Path = "/tmp/data/delta/person_v1"  //La Ruta es diferente a los demás formatos
 ...
 // Se debe agregar la columna que no esta
  val dfReadV1_2_3 = dfReadV1_2
    .withColumn("country", lit("Unknown")) // Lit es un valor literal
    .union(dfReadV3)
