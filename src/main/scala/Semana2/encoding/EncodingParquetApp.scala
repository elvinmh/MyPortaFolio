...
object EncodingParquetApp extends App {
  ...
  val dfReadV1_2_3 = spark.read
    .option("mergeSchema", "true")  // Aquí activamos el mergeSchema, esto hace que cuando spark lea los datos, hara un merge de los tres esquemas y genera una version de datos.
    .schema(schemaReadV3)
    .format("parquet")
...
//Tendremos resultado Null donde no tenemos valores por defecto, pero, eso se puede corregir en el formato ORC