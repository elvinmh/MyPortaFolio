...
/*
Lo primero que hay que hacer para tener una aplicacion funcionando en escala con spark, es dentro del fichero build.sbt,
 debemos activar las dependencias que necesitamos para spark
 */
...
object PrimeraAppSpark extends App {
